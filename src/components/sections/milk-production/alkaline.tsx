        ...
        <div className='w-full flex-col lg:flex-row flex items-stretch justify-stretch'>
          <div className='w-full flex items-center lg:items-start flex-col gap-4 p-4'>
            ...
            <h3 className='w-full typo-h4 text-center lg:text-left base-frame p-4 bg-primary'>
              Удаление жиров и белковых загрязнений
            </h3>
            <p className='leading-tight! xl:leading-normal! typo-body border-l-[5px] border-primary pl-4'>
              Основное средство для ежедневной мойки оборудования в молочной
              промышленности
            </p>
              ...
              <div className='w-full flex flex-col items-stretch justify-start border-4 border-base-black'>
                ...
                <ul className='list-inside m-0 p-2 border-b-4'>
                  <li className='typo-h5 p-0 m-0'>
                    {' '}
                    - Растворяют жиры и белки
                  </li>
                  <li className='typo-h5 p-0 m-0'>
                    {' '}
                    - Удаляют органические остатки
                  </li>
                  <li className='typo-h5 p-0 m-0'>
                    {' '}
                    - Работают в CIP-системах
                  </li>
                </ul>
                <h3 className='typo-body uppercase font-bold p-2 border-b-4  border-base-black'>
                  Где применяются:
                ...
                <ul className='list-inside m-0 p-2'>
                  <li className='typo-h5 p-0 m-0'> - Трубопроводы и танки</li>
                  <li className='typo-h5 p-0 m-0'> - пастеризаторы</li>
                  <li className='typo-h5 p-0 m-0'> - доильное оборудование</li>
                </ul>
              </div>
            </div>
            <LinkButton
              href='/produktsiya/shchelochnye-moyushchie-i-dezinfitsiruyushchie-sredstva/proff-sah-b'
            ...
            <div className='w-full aspect-square flex flex-col base-frame p-2'>
              ...
              <div className='w-full flex flex-col gap-4'>
                <div className='w-full aspect-square shrink-0 border-2 border-base-black relative'>
                  <Image
                    src='/products/sah-b.png'
                    alt='Средство моющее Профф САХ Б'
                    fill
                ...
                <div className='w-full flex flex-col items-start gap-2'>
                  <h3 className='w-full typo-h5 font-bold'>
                    Средство моющее техническое &laquo;Профф&raquo; марки
                    САХ&nbsp;Б
                  </h3>
                  <p className='typo-b3'>
                    Эффективное щелочное средство для удаления жировых и
                    белковых загрязнений, а также молочного камня. Подходит для
                    ручной мойки и CIP-систем, обеспечивает стабильную
