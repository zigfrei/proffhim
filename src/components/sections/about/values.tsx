        ...
        <div className='w-full flex-1 flex flex-col lg:flex-row items-stretch gap-4'>
          ...
          <div className='w-full flex-1 flex flex-col self-stretch gap-2 base-frame p-4'>
            ...
            <div className='w-full flex items-start gap-2'>
              ...
              <p className='typo-b3 text-base-black'>
                Мы постоянно совершенствуем технологии производства и составы продукции, объединяя практический опыт и научные разработки специалистов из Беларуси, России и Швеции. Использование современных формул и внедрение передовых решений позволяет нам создавать эффективные моющие средства, отвечающие актуальным требованиям промышленности и профессиональной санитарии.
              </p>
            </div>
          </div>
          <div className='w-full flex-1 flex flex-col self-stretch gap-2 base-frame p-4'>
            ...
            <div className='w-full flex items-start gap-2'>
              ...
              <p className='typo-b3 text-base-black'>
                Мы уделяем особое внимание экологической безопасности продукции. Использование «зеленых» ПАВов растительного происхождения обеспечивает биоразлагаемость средств и минимальную нагрузку на окружающую среду. Наши продукты безопасны для персонала, эффективны при низких температурах и подходят для использования в системах устойчивого производства.
              </p>
            </div>
          </div>
        </div>
