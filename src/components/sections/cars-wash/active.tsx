      ...
      <div className='w-full flex flex-col items-start justify-center gap-4 lg:gap-8'>
        <div className='w-full flex-col lg:flex-row flex items-stretch justify-stretch'>
          <div className='w-full flex items-center lg:items-start flex-col gap-4 p-4'>
            <h2 className='w-full typo-h2'>Средства для бескон&shy;тактной мойки</h2>

            <h3 className='w-full typo-h4 text-center lg:text-left base-frame p-4 bg-primary'>
              Моющее средство для бесконтактной мойки автомобиля
            </h3>
            <p className='leading-tight! xl:leading-normal! typo-body border-l-[5px] border-primary pl-4'>
              Профессиональные средства для бесконтактной мойки предназначены
              для эффективной очистки кузова от дорожной грязи, дорожной плёнки,
              ...
              <div className='w-full flex flex-col items-stretch justify-start border-4 border-base-black'>
                ...
                <ul className='list-inside m-0 p-2 border-b-4'>
                  <li className='typo-h5 p-0 m-0'>
                    {' '}
                    - удаление дорожной грязи и эксплуатационных загрязнений
                  </li>
                  <li className='typo-h5 p-0 m-0'>
                    {' '}
                    - эффективное обезжиривание поверхности
                  </li>
                  <li className='typo-h5 p-0 m-0'>
                    {' '}
                    - равномерное покрытие кузова активной пеной
                  </li>
                </ul>
                <h3 className='typo-body uppercase font-bold p-2 border-b-4  border-base-black'>
                  Где применяются:
                ...
                <ul className='list-inside m-0 p-2'>
                  <li className='typo-h5 p-0 m-0'>
                    {' '}
                    - ручные и автоматические автомойки
                  </li>
                  <li className='typo-h5 p-0 m-0'> - СТО и сервисные зоны</li>
                  <li className='typo-h5 p-0 m-0'>
                    {' '}
                    - детейлинг-центры и моечные посты
                  </li>
                </ul>
              </div>
            </div>
              ...
              <div className='w-full flex flex-col gap-4'>
                ...
                <div className='w-full flex flex-col items-start gap-2'>
                  <h3 className='w-full typo-h5 font-bold'>
                    Автошампунь «Профф Актив»
                  </h3>
                  <p className='typo-b3'>
                    высокопенное моющее средство для бесконтактной мойки
                    автомобиля. Это концентрированное средство для бесконтактной
                    мойки, которое эффективно удаляет дорожную грязь, жировые и
                    масляные загрязнения, дорожную плёнку и другие
                    эксплуатационные загрязнения. Подходит для профессионального
                    использования на ручных и автоматических автомойках, СТО, в
                    сервисных и детейлинг-центрах.
                  </p>
                </div>
                <LinkButton
                  href='/produktsiya/neitralnye-sredstva/proff-active'
