...
export default function Hero() {
  return (
    <SectionBlock wrapperClassName='relative overflow-hidden p-4! lg:p-12! h-[calc(100vh-76px)] min-h-[660px]'>
      <div className='z-10 w-full flex-1 flex items-start justify-center gap-16'>
        <div className='w-full h-full flex flex-col items-start justify-start gap-4'>
          <h1
            ...
            aria-label='Профессиональная автохимия для мойки автомобилей'
          >
            Профессиональная автохимия для мойки автомобилей
          </h1>
          <p className='leading-tight! xl:leading-normal! lg:text-[1.2rem] typo-body border-l-[5px] border-primary pl-4 text-base-white xl:text-base-black'>
            Средства для бесконтактной мойки, мойки двигателя, очистки колесных дисков, тентов и прицепов. Подберите решения под задачи автомойки, СТО и детейлинг-центра:
          </p>
          <div>
            <ul className='flex flex-col gap-2 text-base-white xl:text-base-black'>
              ...
              <li className='flex items-center gap-2'>
                ...
                <p className='typo-h5'>Средство для очистки колесных дисков автомобиля</p>
              </li>
              <li className='flex items-center gap-2'>
                <div className='flex items-center justify-center p-1 rounded bg-quaternary'>
                  <CheckIcon className='w-3 h-3 lg:h-5 lg:w-5 text-base-white [&>path]:stroke-[2.5]' />
                ...
                <p className='typo-h5'>
                  Решения для мойки тентов и коммерческого транспорта
                </p>
              </li>
            </ul>
          </div>
        ...
        <div className='absolute inset-0 -z-10 w-full h-full xl:relative xl:z-auto xl:flex xl:items-center xl:justify-center'>
          <Image
            src='/car-wash/hero.webp'
            alt='Моющие средства для мойки автомобилей'
            fill
            loading='eager'
            fetchPriority='high'
