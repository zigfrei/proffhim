      ...
      <div className='w-full flex flex-col items-start justify-center gap-4 lg:gap-8'>
        <div className='w-full flex-col lg:flex-row-reverse flex items-stretch justify-stretch'>
          <div className='w-full flex items-center lg:items-start flex-col gap-4 p-4'>
            <h2 className='w-full typo-h2'>Средства для мойки двигателя</h2>
            <h3 className='w-full typo-h4 text-center lg:text-left base-frame p-4 bg-primary'>
              Средство для мойки двигателя от масла и нагара
            </h3>
            <p className='leading-tight! xl:leading-normal! typo-body border-l-[5px] border-primary pl-4'>
              Профессиональное средство для мойки двигателя используется для
              глубокой очистки двигателей, агрегатов и технических узлов
              автомобиля.
            </p>
              ...
              <div className='w-full flex flex-col items-stretch justify-start border-4 border-base-black'>
                ...
                <ul className='list-inside m-0 p-2 border-b-4'>
                  <li className='typo-h5 p-0 m-0'>
                    {' '}
                    - удаление моторных масел, смазок и нагара
                  </li>
                  <li className='typo-h5 p-0 m-0'>
                    {' '}
                    - растворение битумных и нефтяных загрязнений
                  </li>
                  <li className='typo-h5 p-0 m-0'>
                    {' '}
                    - глубокое обезжиривание технических поверхностей
                  </li>
                </ul>
                <h3 className='typo-body uppercase font-bold p-2 border-b-4  border-base-black'>
                  Где применяются:
                ...
                <ul className='list-inside m-0 p-2'>
                  <li className='typo-h5 p-0 m-0'>
                    {' '}
                    - двигатели и агрегаты автомобиля
                  </li>
                  <li className='typo-h5 p-0 m-0'>
                    {' '}
                  ...
                  <li className='typo-h5 p-0 m-0'>
                    {' '}
                    - технические узлы, оборудование и рабочие зоны автомоек
                  </li>
                </ul>
              </div>
            </div>
            ...
            <div className='w-full aspect-square flex flex-col base-frame p-2'>
              ...
              <div className='w-full flex flex-col gap-4'>
                <div className='w-full aspect-square shrink-0 border-2 border-base-black relative'>
                  <Image
                    src='/products/grand.png'
                    alt='Средство моющее «Профф» марки Гранд'
                    fill
                ...
                <div className='w-full flex flex-col items-start gap-2'>
                  <h3 className='w-full typo-h5 font-bold'>
                    Средство моющее «Профф» марки Гранд
                  </h3>
                  <p className='typo-b3'>
                    Профессиональное средство для мойки двигателя автомобиля.
                    Это эффективное средство для мойки двигателя от масла,
                    смазок, нагара, битума и следов нефтепродуктов. Подходит для
                    мойки двигателей, агрегатов и технических узлов автомобиля,
                    а также для глубокой очистки оборудования и рабочих зон
                    автомоек и детейлинг-центров.
                  </p>
                </div>
                <LinkButton
                  href='/produktsiya/shchelochnye-moyushchie-sredstva/proff-grand'
