...
export default function Hero() {
  return (
    <SectionBlock wrapperClassName='relative overflow-hidden p-4! lg:p-12! h-[calc(100vh-76px)] min-h-[650px]'>
      <div className='z-10 w-full flex-1 flex items-start justify-center gap-16'>
          ...
          <div>
            <ul className='flex flex-col gap-2 text-base-white xl:text-base-black'>
              <li className='flex items-center gap-2'>
                ...
                <p className='typo-h5'>Удаление пивного камня, белковых и хмелевых загрязнений</p>
              </li>
              <li className='flex items-center gap-2'>
                <div className='flex items-center justify-center p-1 rounded bg-quaternary'>
                  <CheckIcon className='w-3 h-3 lg:h-5 lg:w-5 text-base-white [&>path]:stroke-[2.5]' />
                </div>
                <p className='typo-h5'>Мойка и дезинфекция резервуаров, трубопроводов и линий розлива</p>
              </li>
              <li className='flex items-center gap-2'>
                <div className='flex items-center justify-center p-1 rounded bg-quaternary'>
                  <CheckIcon className='w-3 h-3 lg:h-5 lg:w-5 text-base-white [&>path]:stroke-[2.5]' />
                </div>
                <p className='typo-h5'>Решения для CIP, внешней мойки и санитарной обработки цехов</p>
              </li>
            </ul>
          </div>
          <BigLinkButton
        ...
        <div className='absolute inset-0 -z-10 w-full h-full xl:relative xl:z-auto xl:flex xl:items-center xl:justify-center'>
          <Image
            src='/brewing-production/hero.webp'
            alt='Моющие средства для пивоварения и напитков'
            fill
            loading='eager'
            fetchPriority='high'
