  ...
  return (
    <SectionBlockSmall>
      <div className='w-full flex flex-col items-start justify-center gap-4 lg:gap-8 mb-8'>
        <h2 className='w-full text-center typo-h3'>Применение на пивоваренных и напиточных предприятиях</h2>
        <ul className='w-full flex-1 flex flex-col lg:flex-row items-stretch gap-4'>
          <li className='w-full flex-1 flex flex-col items-center self-stretch gap-2 base-frame p-4'>
            ...
            <h3 className='typo-h5 text-center'>
              Варочные и бродильные ёмкости, ЦКТ и резервуары
            </h3>
          </li>
          ...
          <li className='w-full flex-1 flex flex-col items-center self-stretch gap-2 base-frame p-4'>
            ...
            />
            <h3 className='typo-h5 text-center'>
              Суслопроводы, трубопроводы, фильтры и теплообменники
            </h3>
          </li>
          <li className='w-full flex-1 flex flex-col items-center self-stretch gap-2 base-frame p-4'>
            <Icon
              icon='material-symbols:wine-bar-outline'
              className='w-20 h-20 text-base-black'
            />
            <h3 className='typo-h5 text-center'>
              Линии розлива и обработки тары
            </h3>
          </li>
          <li className='w-full flex-1 flex flex-col items-center self-stretch gap-2 base-frame p-4'>
            <Icon
            ...
            />
            <h3 className='typo-h5 text-center'>
              Внешние поверхности производственного оборудования
            </h3>
          </li>
          <li className='w-full flex-1 flex flex-col items-center self-stretch gap-2 base-frame p-4'>
            <Icon
            ...
            />
            <h3 className='typo-h5 text-center'>
              Производственные и подсобные помещения, санитарные зоны
            </h3>
          </li>
        </ul>
      </div>
