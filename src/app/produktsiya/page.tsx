...
export const metadata = {
  ...
  description:
    'Каталог моющих и дезинфицирующих средств: щелочные, кислотные, пенные и беспенные решения для мойки и дезинфекции оборудования, инвентаря и производственных помещений.',
  alternates: {
