...
export const metadata = {
  title: "Контрактное производство моющих и дезинфицирующих средств под брендом (СТМ, Private Label) | ПроффХим",
  description: "Контрактное производство бытовой химии и дезсредств под вашим брендом. Разработка рецептур, регистрация, производство от 200 кг. Работаем с клинингом, HoReCa и дистрибьюторами.",
  openGraph: {
    title: 'Контрактное производство моющих и дезинфицирующих средств под брендом (СТМ, Private Label) | ПроффХим',
    description:
